...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{URL::to('/dashboard')}}" class="brand-link">
      <img src="{{asset('public/uploads/images/website/logovuong.jpg')}}" alt="logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span style="color: white" class="brand-text font-weight-light"><strong>VKUBOOKSTORE.COM</strong></span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Bản quyền thuộc về <a href="{{url('trang-chu')}}">vkubookstore.com</a>.</strong>
