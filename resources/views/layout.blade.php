...
<head>
        ...
        <div class="float-icon-hotline">            
            <ul class ="left-icon hotline">
                <li class="hotline_float_icon"><a target="_blank" rel="nofollow" id="messengerButton" href="https://zalo.me/0986369013"><i class="fa fa-zalo animated infinite tada"></i><span>Zalo</span></a></li>
                <li class="hotline_float_icon"><a target="_blank" rel="nofollow" id="messengerButton" href="https://www.messenger.com/t/vkumedia"><i class="fa fa-messenger animated infinite tada"></i><span>Facebook</span></a></li>
                <li class="hotline_float_icon"><a target="_blank" rel="nofollow" id="messengerButton" href="mailto:vkubookstore.com@vkubookstore.com"><i class="fa fa-gmail animated infinite tada"></i><span>Gmail</span></a></li>
            </ul>       
        </div>
        <div id="fb-root"></div>
    </head>
                                ...
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        @if (empty(Session::get('customer_id')))
                                            <li>
                                                <span class="ht-setting-trigger">Kính chào: Quý khách đã đến với vkubookstore.com</span>
                                            </li>
                                            <li>
                                                <a href="{{URL::to('/dangnhap-dangky-taikhoan')}}"><span class="ht-setting-trigger">Đăng ký</span></a>
                                            </li>
                                            <li>
                                                <a href="{{URL::to('/dangnhap-dangky-taikhoan')}}"><span class="ht-setting-trigger">Đăng nhập</span></a>
                                            </li>
                                        @endif
                                        @if (!empty(Session::get('customer_id')))
                                            <li>
                                                <span class="ht-setting-trigger">Kính chào: {{Session::get('customer_name')}} đã đến với vkubookstore.com</span>
                                            </li>
                                            <li>
                                                <span class="ht-setting-trigger"><a href="{{URL::to('/logout')}}">Đăng xuất</a></span>
                                            </li>
                                        @endif
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo">
                                        ...
                                        <p class="info" style="text-align: justify;">
                                            vkubookstore.com - nhà sách online chính hãng, giao hành cực nhanh, uy tín, chuyên nghiệp
                                        </p>
                                    </div>
                                    <ul class="des">
                                        <li>
                                        ...
                                        <li>
                                            <span>Email: </span>
                                            <a href="mailto://vkubookstore.com@vkubookstore.com">vkubookstore.com@vkubookstore.com</a>
                                        </li>
                                    </ul>
                                </div>
