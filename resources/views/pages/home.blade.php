                                                ...
                                                <div class="product_desc">
                                                    <div class="product_desc_info">
                                                        ...
                                                        <div class="price-box">
                                                            ...
                                                            <span class="discount-percentage">-  {{round((($pro_km->product_price - $pro_km->khuyenmai_gia)/$pro_km->product_price)*100,0)}} %</span>
                                                            @else
                                            ...
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product_desc">
                                                    <div class="product_desc_info">
                                                        <div class="product-review">
                                                            <h5 class="manufacturer">
                                                                <a href="{{URL::to('/danh-muc-san-pham/'.$pro_new->slug_category_product)}}">{{$pro_new->category_name}}</a>
                                                            </h5>
                                                        </div>
                                                        <h4><a class="product_name" href="{{URL::to('/chi-tiet-san-pham/'.$pro_km->product_slug)}}">{{cutTitle($pro_new->product_name,10)}}</a></h4>
                                                        <div class="price-box">
                                                        ...
                                                        <div class="single-product-wrap">
                                                            ...
                                                            <div class="product_desc">
                                                                <div class="product_desc_info">
                                                                    <div class="product-review">
                                                                        <h5 class="manufacturer">
                                                                            <a href="{{URL::to('/danh-muc-san-pham/'.$pro_bc->slug_category_product)}}">{{$pro_bc->category_name}}</a>
                                                                        </h5>
                                                                    </div>
                                                                    <h4><a class="product_name" href="{{URL::to('/chi-tiet-san-pham/'.$pro_km->product_slug)}}">{{cutTitle($pro_bc->product_name,10)}}</a></h4>
                                                                    <div class="price-box">
