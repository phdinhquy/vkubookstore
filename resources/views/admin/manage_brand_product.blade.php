...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Quản lý thương hiệu sản phẩm</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách thương hiệu hay nhà sản xuất</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                              ...
                              <tbody tyle="text-align: center;">
                                ...
                                @foreach($all_brand_product as $key => $brand)
                                    ...
                                    <tr style="text-align: center; align-self: center;">
                                        ...
                                        <td>
                                            <a onclick="return confirm('Bạn có chắc là muốn xóa thương hiệu hay nhà sản xuất này không?')" href="{{URL::to('/delete-brand-product/'.$brand->brand_id)}}" class="active styling-edit" ui-toggle-class="">
        ...
        <div class="modal-content">
            <form action="{{URL::to('/insert-brand-product')}}" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Thêm mới thương hiệu hay nhà sản xuất</h4>
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Thông tin của thương hiệu hay nhà sản xuất</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input name="brand_product_name" type="text" class="form-control is-warning" placeholder="Nhập tên của thương hiệu hay nhà sản xuất." required>
                                      </div>
                                    </div>
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        <label>Nội dung mô tả brand</label>
                                        <input name="brand_product_desc" type="text" class="form-control is-warning" placeholder="Nhập nội dung mô tả thương hiệu hay nhà sản xuất." required>
                                      </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="" id="formEdit" role="form" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-header">
                    <h4 class="modal-title">Cập nhật thông tin thương hiệu hay nhà sản xuất</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                                ...
                                <form action="" role="form" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <!-- text input -->
                                      <div class="form-group">
                                        <label>Tên thương hiệu hay nhà sản xuất</label>
                                        <input id="nameEdit" name="brand_product_name" type="text" class="form-control is-warning" placeholder="Nhập tên của thương hiệu hay nhà sản xuất." required>
                                      </div>
                                    </div>
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        <label>Nội dung mô tả thương hiệu hay nhà sản xuất</label>
                                        <input id="descEdit" name="brand_product_desc" type="text" class="form-control is-warning" placeholder="Nhập nội dung mô tả thương hiệu hay nhà sản xuất." required>
                                      </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
