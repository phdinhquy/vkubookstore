                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <!-- select -->
                                        <div class="form-group">
                                            <label>Thương hiệu sản phẩm / Nhà sản xuất</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <!-- select -->
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputWarning">Đơn giá nhập</label>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <!-- select -->
                                        <div class="form-group">
                                            <label class="col-form-label" for="inputWarning">Thương hiệu sản phẩm / Nhà sản xuất</label>
